  ...
  useEffect(() => {
    ...
    const unsubscribe = onSnapshot(q, (snapshot) => {
      if (!snapshot.empty) {
        ...
        // If DB is empty, use default (or handle differently)
    ...
    <Section id="fleet" className="bg-[#050505] py-32 relative overflow-hidden border-t border-white/5">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center mb-16">
          ...
          >
            Entdecke unsere moderne Fahrzeugflotte. Ob Automatik, Schalter oder Motorrad – wir bieten dir für jede Ausbildungsklasse das perfekte Fahrzeug.
          </motion.p>
        </div>
        ...
        {/* Vehicle Grid (handles 25+ cars elegantly) */}
        <motion.div 
          layout
...
fs.writeFileSync('src/components/Fleet.tsx', code);
